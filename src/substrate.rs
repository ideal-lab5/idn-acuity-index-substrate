    ...
    match event.pallet_name() {
        "Balances" => match event.variant_name() {
            ...
            "ReserveRepatriated" => {
                ...
                let value = Event::ReserveRepatriated {

...
pub fn nomination_pools_index_event(
    indexer: &Indexer,
    block_number: u32,
    event_index: u32,
    ...
    match event.variant_name() {
        "Created" => {
            let event = event
                .as_event::<polkadot::nomination_pools::events::Created>()?
                .unwrap();
        ...
        "Bonded" => {
            let event = event
                .as_event::<polkadot::nomination_pools::events::Bonded>()?
                .unwrap();
        ...
        "PaidOut" => {
            let event = event
                .as_event::<polkadot::nomination_pools::events::PaidOut>()?
                .unwrap();
            indexer.index_event_account_id(event.member, block_number, event_index);
            indexer.index_event_pool_id(event.pool_id, block_number, event_index);
            Ok(())
        ...
        "Unbonded" => {
            let event = event
                .as_event::<polkadot::nomination_pools::events::Unbonded>()?
                .unwrap();
            indexer.index_event_account_id(event.member, block_number, event_index);
            indexer.index_event_pool_id(event.pool_id, block_number, event_index);
        ...
        "Withdrawn" => {
            let event = event
                .as_event::<polkadot::nomination_pools::events::Withdrawn>()?
                .unwrap();
            indexer.index_event_account_id(event.member, block_number, event_index);
            indexer.index_event_pool_id(event.pool_id, block_number, event_index);
            Ok(())
        ...
        "Destroyed" => {
            let event = event
                .as_event::<polkadot::nomination_pools::events::Destroyed>()?
                .unwrap();
            indexer.index_event_pool_id(event.pool_id, block_number, event_index);
            Ok(())
        }
        "StateChanged" => {
            let event = event
                .as_event::<polkadot::nomination_pools::events::StateChanged>()?
                .unwrap();
            indexer.index_event_pool_id(event.pool_id, block_number, event_index);
            Ok(())
        }
        "MemberRemoved" => {
            let event = event
                .as_event::<polkadot::nomination_pools::events::MemberRemoved>()?
                .unwrap();
            indexer.index_event_pool_id(event.pool_id, block_number, event_index);
            indexer.index_event_account_id(event.member, block_number, event_index);
            Ok(())
        ...
        "RolesUpdated" => {
            let event = event
                .as_event::<polkadot::nomination_pools::events::RolesUpdated>()?
                .unwrap();
        ...
        "PoolSlashed" => {
            let event = event
                .as_event::<polkadot::nomination_pools::events::PoolSlashed>()?
                .unwrap();
            indexer.index_event_pool_id(event.pool_id, block_number, event_index);
            Ok(())
        }
        "UnbondingPoolSlashed" => {
            let event = event
                .as_event::<polkadot::nomination_pools::events::UnbondingPoolSlashed>()?
                .unwrap();
            indexer.index_event_pool_id(event.pool_id, block_number, event_index);
            indexer.index_event_era_index(event.era, block_number, event_index);
            Ok(())

...
pub fn proxy_index_event(trees: Trees, block_number: u32, event_index: u32, event: subxt::events::EventDetails<PolkadotConfig>) -> Result<(), subxt::Error> {
    match event.variant_name() {
        ...
        "Announced" => {
            ...
            index_event_account_id(trees, event.proxy, block_number, event_index);
            Ok(())
        },
        "ProxyAdded" => {
            ...
            index_event_account_id(trees, event.delegatee, block_number, event_index);
            Ok(())
        },
        "ProxyRemoved" => {

...
pub fn staking_index_event(
    ...
    match event.variant_name() {
        "EraPaid" => {
            let event = event
                .as_event::<polkadot::staking::events::EraPaid>()?
                .unwrap();
        ...
        "Rewarded" => {
            let event = event
                .as_event::<polkadot::staking::events::Rewarded>()?
                .unwrap();
        ...
        "Slashed" => {
            let event = event
                .as_event::<polkadot::staking::events::Slashed>()?
                .unwrap();
        ...
        "SlashReported" => {
            let event = event
                .as_event::<polkadot::staking::events::SlashReported>()?
                .unwrap();
        ...
        "OldSlashingReportDiscarded" => {
            let event = event
                .as_event::<polkadot::staking::events::OldSlashingReportDiscarded>()?
                .unwrap();
        ...
        "Bonded" => {
            let event = event
                .as_event::<polkadot::staking::events::Bonded>()?
                .unwrap();
            indexer.index_event_account_id(event.stash, block_number, event_index);
            Ok(())
        }
        "Unbonded" => {
            let event = event
                .as_event::<polkadot::staking::events::Unbonded>()?
                .unwrap();
            indexer.index_event_account_id(event.stash, block_number, event_index);
            Ok(())
        }
        "Withdrawn" => {
            let event = event
                .as_event::<polkadot::staking::events::Withdrawn>()?
                .unwrap();
            indexer.index_event_account_id(event.stash, block_number, event_index);
            Ok(())
        }
        "Kicked" => {
            let event = event
                .as_event::<polkadot::staking::events::Kicked>()?
                .unwrap();
        ...
        "Chilled" => {
            let event = event
                .as_event::<polkadot::staking::events::Chilled>()?
                .unwrap();
            indexer.index_event_account_id(event.stash, block_number, event_index);
            Ok(())
        }
        "PayoutStarted" => {
            let event = event
                .as_event::<polkadot::staking::events::PayoutStarted>()?
                .unwrap();
            indexer.index_event_era_index(event.era_index, block_number, event_index);
        ...
        "ValidatorPrefsSet" => {
            let event = event
                .as_event::<polkadot::staking::events::ValidatorPrefsSet>()?
                .unwrap();
            indexer.index_event_account_id(event.stash, block_number, event_index);
            Ok(())
        }

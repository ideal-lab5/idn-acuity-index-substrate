...
pub fn balance_index_event(indexer: &Indexer, block_number: u32, event_index: u32, event: subxt::events::EventDetails<PolkadotConfig>) -> Result<(), subxt::Error> {
    match event.variant_name() {
        ...
        "ReserveRepatriated" => {
            ...
            indexer.index_event_account_id(reserve_repatriated_event.from, block_number, event_index);

...
pub fn treasury_index_event(
    ...
    match event.variant_name() {
        "Proposed" => {
            let event = event
                .as_event::<polkadot::treasury::events::Proposed>()
                .unwrap()
                .unwrap();
        ...
        "Awarded" => {
            let event = event
                .as_event::<polkadot::treasury::events::Awarded>()
                .unwrap()
                .unwrap();
            indexer.index_event_proposal_index(event.proposal_index, block_number, event_index);
        ...
        "Rejected" => {
            let event = event
                .as_event::<polkadot::treasury::events::Rejected>()
                .unwrap()
                .unwrap();
            indexer.index_event_proposal_index(event.proposal_index, block_number, event_index);
            Ok(())
        ...
        "SpendApproved" => {
            let event = event
                .as_event::<polkadot::treasury::events::SpendApproved>()
                .unwrap()
                .unwrap();
            indexer.index_event_proposal_index(event.proposal_index, block_number, event_index);
